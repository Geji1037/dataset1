...
def fl_finetune(
        # model/data params
        global_model: str = '/root/.cache/modelscope/hub/models/LLM-Research/Meta-Llama-3-8B-Instruct',
        data_path: str = './data',
    ...
    print(f"this is data_path:",data_path)
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        if "Question" in data_point:
            ...
            # 方案2：使用思考过程+最终回答
            # output = data_point.get("Complex_CoT", "") + "\n\n" + data_point["Response"]
        
            # 生成完整提示
            full_prompt = prompter.generate_prompt(instruction, None, output)
            user_prompt = prompter.generate_prompt(instruction,None)
            print("=== Full Prompt ===")
            print(full_prompt)
            print("=== User Prompt ===")
            print(user_prompt)
